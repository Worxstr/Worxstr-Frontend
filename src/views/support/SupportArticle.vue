<template lang="pug">
  v-container.pt-8
    .mb-6
      h4.text-h4.font-weight-bold.mb-2 {{ article.title }}
      router-link(:to="{name: 'support'}") Back to support home
    v-row
      v-col(cols='12' md='9')
        v-card
          .pa-8
      ...
      v-col(cols='12' md='3')
        div(style='position: sticky; top: 100px')
          h6.text-h6.mb-4 Other articles in {{ article.category.title }}
          .d-flex.flex-column
            router-link.mb-2(
...
export default class SupportArticle extends Vue {
  ...
  article = {
    title: 'Dummy article ' + this.$route.params.articleId,
